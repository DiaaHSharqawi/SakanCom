...
public class TenantViewAvailableHouseFeatureStep {
        ...
        //--------------------------------------------------
        private static TenantAvailableHouse tenantAvailableHouse; // new obj
        ...
        public static void before_all() throws SQLException {
            ...
            tenantAvailableHouse= new TenantAvailableHouse(requestedHouseConnecter,advertisementHousePrinter);
        }
        @AfterAll
    ...
    public void iShouldSeeTheReservationDisplayedOnTheScreen() {
      assertTrue(  tenantAvailableHouse.getIsPrinted());
    }
